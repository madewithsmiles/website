...
(function () {
  ...
  function BlogService(DateService) {
    ...
    var postMetaData = [{
      ...
      datePath: "8-25-2017",
      titlePath: "music_image",
      title: "Musecage: Music and Image Classification",
      author: "Nipun Ramakrishnan",
      date: DateService.blogDate(8, 27, 2017),
      timestamp: DateService.timestamp(8, 27, 2017),
      tags: ["Project Musecage", "Computer Vision", "Music"],
      category: "Preseason Demo",
